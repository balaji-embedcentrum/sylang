...
export const LANGUAGE_CONFIGS: Record<string, LanguageConfig> = {
    'sylang-productline': {
        ...
        extensions: ['.ple'],
        keywords: [
            'def', 'productline', 'name', 'description', 'owner', 'tags', 
    ...
    'sylang-functions': {
        ...
        keywords: [
            ...
            'tags', 'safetylevel', 'partof', 'enables', 'allocatedto', 'feature', 'config'
        ],
    ...
    'sylang-failuremodeanalysis': {
        ...
        keywords: [
            ...
            'causes', 'effects', 'mitigation', 'high', 'medium', 'low', 'config'
        ],
    ...
    'sylang-failuremodecontrols': {
        ...
        keywords: [
            ...
            'immediate', 'delayed', 'complete', 'partial', 'mature', 'developing', 'research', 'config'
        ],
    ...
    'sylang-variantmodel': {
        ...
        keywords: [
            ...
            'selected', 'use', 'featureset', 'name', 'description', 'owner', 'tags', 'safetylevel'
        ],
    ...
    'sylang-safety': {
        ...
        keywords: [
            ...
            'conditions', 'functions_affected', 'name', 'description', 'owner', 'tags', 'config'
        ],
    ...
    'sylang-risk': {
        ...
        keywords: [
            ...
            'QM', 'A', 'B', 'C', 'D', 'ASIL-A', 'ASIL-B', 'ASIL-C', 'ASIL-D', 'config'
        ],
        snippetFile: 'safety.json',
    ...
    'sylang-components': {
        ...
        extensions: ['.req'],
        keywords: [
            'def', 'reqsection', 'requirement', 'name', 'description',
            'source', 'derivedfrom', 'safetylevel',
            ...
            'Communication', 'Digital', 'Analog', 'SPI', 'I2C', 'CAN', 'LIN', 'CMOS', 'config'
        ],
    ...
    'sylang-blocks': {
        ...
        keywords: [
            ...
            'feature', 'function', 'use', 'port', 'in', 'out', 'type', 'electrical', 'mechanical', 'data',
    ...
    'sylang-test': {
        ...
        keywords: [
            ...
            'blocked', 'skipped', 'pending', 'in-progress', 'A', 'B', 'C', 'D', 'QM', 'ASIL-A', 'ASIL-B', 'ASIL-C', 'ASIL-D', 'config'
        ],
